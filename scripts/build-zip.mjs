...
const files = [
  ...
  'includes/Audit/ActivityReadService.php',
  ...
  'includes/Content/PublishContentService.php',
  ...
  'includes/Navigation/NavigationApplyService.php',
  ...
  'includes/Terms/CreateTermService.php',
  'includes/Rest/RequestGuard.php',
  'includes/Rest/AdminReadRoutes.php',
  'includes/Rest/ApprovalRoutes.php',
