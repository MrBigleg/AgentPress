...
| Safe bootstrap context | `OBSERVED`, local role/schema/privacy and repository gates pass; hosted gate pending | [Experiment 017](docs/evidence/sessions/2026-08-31-exp-017-get-context.md) |
...
The next dependency-ordered implementation experiment is `AP-012 — Implement get-site-structure`. AP-001 through AP-010 are merged; AP-011 passes its local role, schema, privacy, capability-mutation, regression, and package gates, with hosted verification pending.
