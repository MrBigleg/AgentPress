...
| [EXP-011](evidence/sessions/2026-08-31-exp-011-database-repositories.md) | 2026-08-31 | Can exact versioned tables and typed repositories migrate idempotently and preserve bounded data through the v0.1 lifecycle? | AP-005 | `IN_PROGRESS` | `c0db4b8` | database migration and repository experiment |
