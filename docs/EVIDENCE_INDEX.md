...
| [EXP-013](evidence/sessions/2026-08-31-exp-013-safe-mode-discovery-policy.md) | 2026-08-31 | Can Safe Mode and live WordPress capabilities keep discovery/execution no broader than actual authority with every R3 surface absent? | AP-007 | `SUPPORTED` | `c510713` | 4 roles, logged out, live capability mutation, 16-operation envelope, 15 fixed abilities, 7 forbidden route guesses |
