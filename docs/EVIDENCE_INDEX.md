...
| [EXP-015](evidence/sessions/2026-08-31-exp-015-sanitized-audit-logging.md) | 2026-08-31 | Can authenticated attempts emit bounded useful audit rows while secrets and unauthenticated traffic remain absent? | AP-009 | `SUPPORTED` | `22649d5` | four-outcome/secret/200 KB/unauthenticated/storage-failure matrices; commit and hosted gate pending |
