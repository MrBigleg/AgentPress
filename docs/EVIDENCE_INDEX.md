...
| [EXP-018](evidence/sessions/2026-09-01-exp-018-site-structure.md) | 2026-09-01 | Can get-site-structure return a bounded visible hierarchy/count/taxonomy/location snapshot without content or destination leakage? | AP-012 | `SUPPORTED` | `dca847f` | three roles; 200-page cap; exact visible counts; four content/destination sentinels absent; local gates green |
