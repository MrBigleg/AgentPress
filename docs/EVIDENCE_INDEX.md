...
| [EXP-013](evidence/sessions/2026-08-31-exp-013-safe-mode-discovery-policy.md) | 2026-08-31 | Can Safe Mode and live WordPress capabilities keep discovery/execution no broader than actual authority with every R3 surface absent? | AP-007 | `SUPPORTED` | `c510713` | capability/object/R3 matrices and [successful run 33361719090](https://github.com/MrBigleg/AgentPress/actions/runs/33361719090) |
