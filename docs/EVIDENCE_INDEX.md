...
| [EXP-012](evidence/sessions/2026-08-31-exp-012-common-schemas-errors.md) | 2026-08-31 | Can common closed schemas and safe error normalization reject every invalid class and serialize the documented contracts? | AP-006 | `IN_PROGRESS` | `9952e76` | schema and error contract experiment |
