...
| [EXP-015](evidence/sessions/2026-08-31-exp-015-sanitized-audit-logging.md) | 2026-08-31 | Can authenticated attempts emit bounded useful audit rows while secrets and unauthenticated traffic remain absent? | AP-009 | `SUPPORTED` | `b416060` | four-outcome/secret/200 KB/unauthenticated/storage-failure matrices and [successful run 33404819589](https://github.com/MrBigleg/AgentPress/actions/runs/33404819589) |
