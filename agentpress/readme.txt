...
1. Download the installable ZIP attached to the v0.1.0-rc.1 GitHub prerelease. Do not use GitHub's Code > Download ZIP source archive.
2. In wp-admin, open Plugins > Add New Plugin > Upload Plugin.
3. Choose `agentpress-0.1.0-rc.1.zip`, select Install Now, and then activate AgentPress.
...
= 0.1.0-rc.1 =
* First release candidate with 15 AgentPress Abilities, permission-aware reads and writes, immutable Change Sets, human approval, classic-menu support, and sanitized activity history.
